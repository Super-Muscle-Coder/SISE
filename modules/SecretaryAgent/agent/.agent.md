...
- Run audits, append `document/agent_schedule.md`, refresh `.context/agent_schedule.json`, validate `.context/openapi.yaml`.
...
- Append audit logs to `document/agent_schedule.md` and refresh `.context/agent_schedule.json`.
