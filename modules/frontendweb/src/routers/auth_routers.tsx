    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-[#EFEFEF] p-4">
            <div className="w-full max-w-md bg-white rounded-2xl shadow-lg p-8">
                ...
                {error && (
                    <div
                        className="mb-6 p-4 bg-red-50 border border-red-200 rounded-lg text-red-700 text-sm animate-in fade-in duration-300"
                        role="alert"
                    >
                        {error}
                    </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            disabled={isLoading}
                            className={`w-full px-5 py-3 rounded-full border-2 focus:outline-none focus:ring-2 focus:ring-blue-600 transition-all duration-300 ${validationErrors.username ? 'border-red-400 bg-red-50' : 'border-gray-300'
                    ...
                    <div>
                        ...
                        <div className="relative">
                            <input
                                ...
                                onChange={handleInputChange}
                                disabled={isLoading}
                                className={`w-full px-5 py-3 rounded-full border-2 focus:outline-none focus:ring-2 focus:ring-blue-600 transition-all duration-300 pr-12 ${validationErrors.password ? 'border-red-400 bg-red-50' : 'border-gray-300'
                                    } ${isLoading ? 'bg-gray-100 cursor-not-allowed' : 'bg-white'}`}
                                placeholder="••••••"
                            />
                            <button
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            onChange={handleInputChange}
                            disabled={isLoading}
                            className={`w-full px-5 py-3 rounded-full border-2 focus:outline-none focus:ring-2 focus:ring-blue-600 transition-all duration-300 ${validationErrors.email ? 'border-red-400 bg-red-50' : 'border-gray-300'
                                } ${isLoading ? 'bg-gray-100 cursor-not-allowed' : 'bg-white'}`}
                            placeholder="you@example.com"
                        />
                    ...
                    <div>
                        ...
                        <div className="relative">
                            <input
                                ...
                                onChange={handleInputChange}
                                disabled={isLoading}
                                className={`w-full px-5 py-3 rounded-full border-2 focus:outline-none focus:ring-2 focus:ring-blue-600 transition-all duration-300 pr-12 ${validationErrors.confirmPassword ? 'border-red-400 bg-red-50' : 'border-gray-300'
                                    } ${isLoading ? 'bg-gray-100 cursor-not-allowed' : 'bg-white'}`}
                                placeholder="••••••"
                            />
                            <button
