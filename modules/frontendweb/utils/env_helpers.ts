...
declare global {
    interface ImportMetaEnv {
        ...
        // ====================================================================
        // RETRY POLICY (per data_schema.yaml retry_policy)
        // ====================================================================
        ...
        // ====================================================================
        // IDEMPOTENCY & PRESIGNED UPLOAD (per data_schema.yaml)
        // ====================================================================
        ...
        readonly VITE_SESSION_ENDED_EVENT: string;
        readonly VITE_SESSION_STARTED_EVENT: string;

        // ====================================================================
        // MEDIA WORKFLOW (T004-03)
        // ====================================================================
        ...
        // ====================================================================
        // EVALUATION WORKFLOW (T004-06)
        // ====================================================================
        readonly VITE_EVAL_POLLING_INTERVAL_MS: string;
        readonly VITE_EVAL_MAX_TIMEOUT_MS: string;
        readonly VITE_EVAL_MAX_RETRIES: string;
        readonly VITE_EVAL_BACKOFF_MS: string;
        readonly VITE_EVAL_RUN_BUTTON_LABEL: string;
        readonly VITE_EVAL_STOP_BUTTON_LABEL: string;
